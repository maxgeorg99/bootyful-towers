...
---@class (exact) elements.Box : Element
---@field new fun(opts: elements.Box.Opts): elements.Box
---@field init fun(self: elements.Box, opts: elements.Box.Opts)
---@field kind "filled" | "empty"
---@field quads vibes.NineSlice
---@field _layout layout.Layout
local BoxElement = class("elements.Box", { super = Element })

---@class elements.Box.Opts : Element.Opts
...
--- @param opts elements.Box.Opts
function BoxElement:init(opts)
  validate(opts, {
    box = Box,
    kind = "string",
  })
...
function BoxElement:append_child(el) self._layout:append_child(el) end
function BoxElement:remove_child(el) self._layout:remove_child(el) end

function BoxElement:_render()
...
function BoxElement:_update() end
function BoxElement:_focus() end
function BoxElement:_blur() end
