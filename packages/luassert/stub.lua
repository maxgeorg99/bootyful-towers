...
function stub.new(object, key, ...)
  ...
  local fn = (
    return_values.n == 1
    and util.callable(return_values[1])
    and return_values[1]
  )
  local defaultfunc = fn or function() return unpack(return_values) end
  local oncalls = {}
  local callbacks = {}
  ...
  s.returns = function(...)
    ...
    defaultfunc = function() return unpack(return_args) end
    return s
  end

  s.invokes = function(func)
    defaultfunc = function(...) return func(...) end
    return s
  end
  ...
  s.on_call_with = function(...)
    ...
    return {
      returns = function(...)
        ...
        callbacks[match_args] = function() return unpack(return_args) end
        return s
      end,
      invokes = function(func)
        table.insert(oncalls, match_args)
        callbacks[match_args] = function(...) return func(...) end
        return s
      end,
    }
  end
